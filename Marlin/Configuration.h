...
#define STRING_CONFIG_H_AUTHOR "(Igor ALmeida, default config)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 224.05
  #define DEFAULT_bedKi  43.19
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000, 1000, 40, 800 }
